    ...
    return (
        <>
            <div className="anim-opacity columns-1 gap-4 sm:columns-2 xl:columns-3 2xl:columns-4 text-sm">
                <div className="after:content relative mb-5 flex h-[300px] flex-col items-center justify-center gap-4 overflow-hidden rounded-lg bg-black/90 px-6 text-center text-white shadow-highlight after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:shadow-highlight lg:pt-0">
                    ...
                    <p className="mb-4 text-sm absolute bottom-2 right-12 text-white/80">Jarek Olszewski</p>
                </div>
                <Images img={s1img} />
                <Images img={s3img} />
                <Images img={s2img} />
