...
export function Footer() {
  return (
    <footer className="bg-white p-4 dark:bg-black/90 md:p-8 lg:p-10">
      <div className="mx-auto max-w-screen-xl text-center">
        <Link
          href="/"
          className="flex items-center justify-center text-3xl font-semibold text-gray-900 dark:text-white"
        >
          Jarek Olszewski
        </Link>
